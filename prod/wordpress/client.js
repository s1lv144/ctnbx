...
function loadChatbox()
{
	...
	/*function e(){
	n.$showHideChatbox.text("↓"),
	n.$username.text(chatbox.username),
	n.$chatBody.show(),
	n.$chatboxResize.css("z-index",99999),
	n.$messages[0].scrollTop=n.$messages[0].scrollHeight
	}
function t(){
	n.$showHideChatbox.text("↑"),
	n.$username.html(chatbox.NAME),
	n.$chatBody.hide(),
	n.$chatboxResize.css("z-index",-999)
	}*/
    function hide(){
        $('#socketchatbox-showHideChatbox').text("↑");
